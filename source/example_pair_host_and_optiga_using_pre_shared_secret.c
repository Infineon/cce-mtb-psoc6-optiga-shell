...
const uint8_t platform_binding_shared_secret_metadata_final [] = {
    /* Metadata to be updated */ 0x20, 0x17,
    /* LcsO */ 0xC0, 0x01, FINAL_LCSO_STATE,       /* Refer Macro to see the value or some more notes */
    /* Change/Write Access tag */ 0xD0, 0x07, 0xE1, 0xFC, LCSO_STATE_OPERATIONAL,   /* LcsO < Operational state */
    0xFE, 0x20, 0xE1, 0x40,
    /* Read Access tag */ 0xD1, 0x03, 0xE1, 0xFC, LCSO_STATE_OPERATIONAL,   /* LcsO < Operational state */
    /* Execute Access tag */ 0xD3, 0x01, 0x00,   /* Always */
    /* Data object Type- */ 0xE8, 0x01, 0x22,   /* Platform binding secret type */
};
